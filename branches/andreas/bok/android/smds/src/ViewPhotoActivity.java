...
public class ViewPhotoActivity extends Activity implements View.OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		photoUri = startIntent.getStringExtra(ViewThumbnailsActivity.EXTRA_PHOTO_URI);
		pageUri = startIntent.getStringExtra(ViewThumbnailsActivity.EXTRA_PHOTO_PAGE_URI);
