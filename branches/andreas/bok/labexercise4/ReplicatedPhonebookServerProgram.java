...
public class ReplicatedPhonebookServerProgram {
	...
	public void InitTest() throws NoSuchAlgorithmException, IOException {
	...
	public static void main(String[] args) throws NoSuchAlgorithmException, IOException {
		ReplicatedPhonebookServerProgram p = new ReplicatedPhonebookServerProgram();
		p.InitTest();
		p.TestJoinRemoveServer();
		p.AfterTest();
...
//		System.out.println("Vectorclock for primary server: " + primary.getVectorClock().toString());
//		System.out.println("Vectorclock for secondary server: " + primary.getVectorClock().toString());
//		System.out.println("Vectorclock for tertiary server: " + primary.getVectorClock().toString());
	}
}