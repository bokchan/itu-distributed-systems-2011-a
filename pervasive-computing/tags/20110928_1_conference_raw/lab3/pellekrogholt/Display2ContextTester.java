...
public class Display2ContextTester extends AbstractContextClient {
...
//	final Attending attending = new Attending();
	...
	public Display2ContextTester(String serviceUri) {
		super(serviceUri);

		// similar to the VisitorDetector 
		try {
			// todo: figure out the arrive drelation ? should there be two ?
			DisplayMonitor display_monitor = new DisplayMonitor(serviceUri, display2, arrived);
...
////            getContextService().addContextItem(visitor2.getId(), attending, new Presentation("presentation1@itu.dk", "JCAF Demo"));
	...
	public static void main(String[] args) {
		new Display2ContextTester("testcustom");
	}
}
