...
public class UserInterface {
  private IDataCollection<IItem<?>> data;
  private bok.labexercise4.extended.gui.ServerInterface remoteServer;
  
  public UserInterface (IDataCollection<IItem<?>> pb, bok.labexercise4.extended.gui.ServerInterface server) {
    data = pb;
    remoteServer = server;
  }
  ...
  void AddCommand (BufferedReader bisr) throws IOException {
    ...
    IItem<Car> car = new Car(name, phoneNo);
