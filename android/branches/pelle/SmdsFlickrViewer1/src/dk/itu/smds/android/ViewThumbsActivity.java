...
public class ViewThumbsActivity extends Activity {
	...
	/* 
	 * note: needed for the ViewPhotoActivity 
	 * 
	 * pelle: it is not obvious here that they have to be public 
	 * according to 'frza' its a convention and its not a problem since they can't be accessed 
	 * by other applications as fare as i recall his explanation.
	 * 
	 */ 
...
//			@Override
			public void onClick(View v) {
				...
				// pelle: not needed for step 3
				// Intent intent = new Intent(Intent.ACTION_VIEW,Uri.parse(pi.photo.getUrl()));

				//pelle: needed for step 3
				Intent intent = new Intent(ViewThumbsActivity.this,ViewPhotoActivity.class);
